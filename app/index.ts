export interface Karyawan { id_karyawan?: string; username: string; password?: string; nama_karyawan: string; role: string; status_aktif: boolean; akses_halaman: string[]; created_at?: string; nomor_wa?: string; email?: string; }
...
export interface RiwayatPesan { id_pesan?: string; nomor_wa: string; nama_profil_wa: string; arah_pesan: 'IN' | 'OUT'; isi_pesan: string; waktu_pesan: string; bicara_dengan_cs?: boolean; created_at?: string; url_media?: string; jenis_pesan?: 'chat' | 'system' | 'bot' | 'image' | 'video' | 'document' | 'audio'; wamid?: string; is_edited?: boolean; }
export interface ClaimPromo { id_claim?: string; nomor_wa: string; nomor_seri: string; tipe_barang: string; tanggal_pembelian: string; nama_toko?: string; jenis_promosi?: string; validasi_by_mkt: string; validasi_by_fa: string; catatan_mkt?: string; catatan_fa?: string; nama_jasa_pengiriman?: string; nomor_resi?: string; resi_sent_at?: string | null; link_kartu_garansi?: string | File | null; link_nota_pembelian?: string | File | null; nomor_wa_update?: string | null; nama_pendaftar?: string | null; nama_penerima_claim?: string | null; alamat_pengiriman?: string | null; kelurahan_pengiriman?: string | null; kecamatan_pengiriman?: string | null; kabupaten_pengiriman?: string | null; provinsi_pengiriman?: string | null; kodepos_pengiriman?: string | null; created_at?: string; tanggal_cetak?: string[]; }
...
export interface BudgetItem { purpose: string; qty: number; cost_unit: number; value: number; petty_cash?: string; item_type?: 'event' | 'petty'; }
export interface BudgetApproval { id_budget?: string; proposal_no: string; title: string; period: string; objectives: string; detail_activity: string; expected_result: string; total_cost: number; budget_source: string; drafter_name: string; proposed_name?: string; mgt_name_1?: string; mgt_name_2?: string; mgt_name_3?: string; finance_name?: string; mgt_comment_1?: string; mgt_comment_2?: string; mgt_consent?: string; finance_consent?: string; items: BudgetItem[]; created_at?: string; attachment_urls?: (string | File | null)[]; event_date?: string; event_time?: string; event_location?: string; event_image?: string; linked_event_id?: string; wa_group_link?: string; }
...
export interface EventData { id?: string; title: string; date: string; price: string; image: string; stock: number; status: string; detail_acara: string; created_at?: string; bank_info?: string; display_start_date?: string | null; registration_open_date?: string | null; registration_close_date?: string | null; }
