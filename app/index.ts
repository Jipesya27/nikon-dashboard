...
export interface BudgetApproval { id_budget?: string; proposal_no: string; title: string; period: string; objectives: string; detail_activity: string; expected_result: string; total_cost: number; budget_source: string; drafter_name: string; proposed_name?: string; mgt_name_1?: string; mgt_name_2?: string; mgt_name_3?: string; finance_name?: string; mgt_comment_1?: string; mgt_comment_2?: string; mgt_consent?: string; finance_consent?: string; items: BudgetItem[]; created_at?: string; attachment_urls?: (string | File | null)[]; event_date?: string; event_time?: string; event_image?: string; linked_event_id?: string; wa_group_link?: string; }
